    ...
    <div className="flex min-h-screen items-center justify-center bg-[#f1f5f9] px-4">
      <div className="flex w-full max-w-[500px] flex-col items-center">
        <div className="mb-6 text-center">
          <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-brand text-white shadow-sm">
            <Shield className="h-8 w-8" />
          </div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">Admin Login</h1>
          <p className="mt-1 text-sm text-slate-400">Masuk ke Admin Console</p>
        </div>
        ...
        <div className="w-full rounded-3xl border border-slate-100 bg-white p-10 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-3 flex h-12 w-full items-center justify-center rounded-xl text-sm font-semibold text-white bg-brand hover:opacity-95 transition disabled:opacity-50"
            >
              {loading ? (
